...
export const APP_SUBTITLE = "LOOP PARK · 千门八将（合席）";
export const STORAGE_KEY = "loop-park-risk-kanban-v2";
export const BOARD_VIEW_KEY = "loop-park-board-view-v1";
export const MY_SEAT_KEY = "loop-park-my-seat-v1";
export const MINE_ONLY_KEY = "loop-park-mine-only-v1";
export const STORE_VERSION = 2;

/** 分席别名 → 合席（现网六席） */
export const SEAT_ALIASES: Record<string, OwnerSeat> = {
  正将: "正将",
  提将: "提将",
  风谣: "风谣",
  风将: "风谣",
...
export const GLOBAL_GATES: GlobalGate[] = [
  ...
  },
  {
    ...
    enforcingSeats: ["风谣", "反将"],
  },
];

export const SEAT_META: Record<
  OwnerSeat,
  { role: string; duty: string; aliases: string; tone: string }
> = {
  正将: {
    role: "总闸 / 拍板",
    duty: "拍板；超货盘 · 价外 · 9# 闸",
...
export const SEAT_COLUMN_ACCENT: Record<OwnerSeat, string> = {
  ...
  提将: "from-blue-400/30",
  风谣: "from-violet-400/35",
  反将: "from-rose-400/35",
  火脱: "from-orange-400/35",
  除将: "from-teal-400/35",
};
